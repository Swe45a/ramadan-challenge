    ...
    <div className="space-y-8 animate-fadeIn" dir="rtl">
      ...
      {isCompleted ? (
        ...
        <button
          ...
          type="button"
          className="w-full flex items-center justify-center gap-4 bg-gradient-to-r from-orange-500 to-orange-700 text-white py-8 rounded-3xl font-bold text-3xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all active:scale-[0.98]"
        >
